...
`VocabularyRepository`, `ImageMatrixNodeRepository`,
`PartOfRepository`, `LogisticRegressionModelRepository`) extend
`Neo4jRepository<T, Long>` and use only the inherited CRUD operations:
